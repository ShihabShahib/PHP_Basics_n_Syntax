...
<body>
    ...
    // echo str_word_count("Micro Solution");
    ...
    //a string. If a match is found, the fucntion returns the 
    //character position of the first match. If no match is found, 
    ...
    // echo str_replace("Jetakechangekorbo", "jadiyechangekorbo", "Purata_jetake...porjnto Jetakechangekorbo");
    // echo str_replace("Abhishek", "Micro Solution", "Hello Abhishek");
    
    // Example 6
    //print function_name("what will repeat", how many time will repeat);
